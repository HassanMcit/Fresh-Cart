      ...
      <nav className="bg-primary border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center md:space-x-6 justify-between mx-auto p-4">
          ...
          <div
            className={`${
              open ? "flex" : "hidden"
            } w-full flex-col md:flex-row flex-grow md:flex ${
              token ? "md:justify-between" : "md:justify-end"
            }  md:w-auto`}
            id="navbar-default"
          >
            {token && (
              <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 items-start  border-gray-100 md:bg-transparent rounded-t-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <NavLink
                    to="/"
                    className="block py-2 px-3 text-gray-900 rounded md:bg-transparent  md:p-0 dark:text-white md:dark:text-green-500"
                    aria-current="page"
                  >
                    Home
                  </NavLink>
              ...
              {token && (
                <ul className="font-medium flex flex-wrap  p-4 md:p-0 items-center  border-gray-100 md:bg-transparent rounded-b-lg bg-gray-50 md:flex-row md:space-x-3 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <li>
                    <Link
                      to="#"
                      className="block py-2 px-3 text-neutral-800 rounded bg-transparent md:text-black md:p-0 dark:text-white md:dark:text-black"
                      aria-current="page"
                    >
                  ...
                  <li>
                    <Link
                      to="#"
                      className="block py-2 px-3 text-neutral-800 rounded bg-transparent md:text-black md:p-0 dark:text-white md:dark:text-black relative"
                      aria-current="page"
                    >
                ...
                {token ? (
                  ...
                  <>
                    ...
                    <li>
                      <NavLink
                        to="/login"
                        className="block py-2 cu px-3 text-gray-900  rounded md:bg-transparent  md:p-0 dark:text-white md:dark:text-green-500"
                        aria-current="page"
                      >
                        Login
                      </NavLink>
