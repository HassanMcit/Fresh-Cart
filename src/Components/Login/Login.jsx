...
export default function Login() {
  ...
  const sample = Joi.object({
    ...
    .messages({
      ...
      'string.pattern.base': "Password must be at least 8 characters, include one uppercase, one lowercase, one number, and one special character",
      ...
      <form className="max-w-lg mx-10 md:mx-auto" onSubmit={handleSubmit(formSubmit)}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          autoComplete="new-user"
            ...
            placeholder=" "
            {...register("email",{onBlur: () => trigger('email'), onChange: () => trigger('email')})}
          />
          <label
            htmlFor="email"
            className={`${
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <input
            ...
            placeholder=" "
            {...register("password",{onBlur: () => trigger('password'), onChange: () => trigger('password')})}
          />
          <label
            htmlFor="password"
            className={`${
